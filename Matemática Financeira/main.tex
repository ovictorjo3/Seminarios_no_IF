	...
	\section{Financiamento SAC}
		...
		\begin{frame}{Financiamento SAC}
			\begin{exampleblock}{Exemplo 2.}
				\justifying
				Um financiamento de R\$ 60.000 deve ser devolvido de acordo com o SAC (Sistema de Amortização Constante) em 4 prestações anuais à uma taxa de juros de 6\% ao ano. Construa a planilha de pagamento dessa dívida.
			\end{exampleblock}
		\end{frame}
		...
		\begin{frame}{Financiamento SAC - Exemplo 2.}
			\begin{table}[h]
				...
				\begin{tabular}{|c|c|c|c|c|c|}
					\hline
					ANO & DÍVIDA & AMORT & JUROS & PARCELA & SALDO \\
					\hline
					0 & - & - & - & - & 60.000 \\
					\hline
					1 & & & & & \\
