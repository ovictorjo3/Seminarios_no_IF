...
\begin{document}
	...
	\section{Financiamento SAC}
		...
		\begin{frame}{Financiamento SAC - Exemplo 5.}
			\begin{exampleblock}{Exemplo 5.}
				\justifying
				Em um financiamento em SAC de R\$ 72.000,00 a uma taxa de 1\% a.m. com 60 parcelas. Qual o total de juros pago?
			\end{exampleblock}
		\end{frame}
	...
	\section{Referências}
		...
		\end{frame}
	\begin{frame}{Lembre-se...}
		$$\includegraphics[scale=0.4]{imagens/julius.png}$$
	\end{frame}
