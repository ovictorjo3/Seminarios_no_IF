...
\begin{document}
	...
	\section{Aplicações}
		...
		\begin{frame}{Financiamento SAC - Exemplo 1a.}
			\begin{table}[h]
				\centering
		...
		\begin{frame}{Financiamento SAC - Exemplo 1b.}
			\begin{table}[h]
				\centering
				\begin{tabular}{|c|c|c|c|c|c|}
					\hline
		...
		\begin{frame}{Financiamento Price - Exemplo 2b.}
			\begin{table}[h]
				\centering
				\begin{tabular}{|c|c|c|c|c|c|}
					\hline
